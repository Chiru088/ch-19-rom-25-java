class Country {
    ...
    public static int getCountryCode(String countryName) {
        ...
        if (countryName == "India") {
            ...
            System.out.println(countryName + " is not a valid country or code not available.");
        }
...
// multiple condition statments
          ...
          public static int getCountryCode(String countryName){
			  ...
			  if(countryName == "India"){
				  ...
				  System.out.println("countryName + in valid");
				}
